...
class _KioskChatScreenState extends State<KioskChatScreen> {
  ...
  tooltip: _speakAudio ? 'Voice response ON' : 'Voice response OFF',
  ...
  SizedBox(height: XSSpacing.sm * s),
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                _quickChip(palette, 'Summarize my findings',
                    Icons.assessment_outlined),
                // Phrased to invite a visual answer — these are the prompts the
                // assistant most reliably answers with an xray_compare /
                // vitals_table card.
                _quickChip(palette, 'Compare with a normal X-ray',
                    Icons.compare_outlined),
                _quickChip(palette, 'Show vitals against reference ranges',
                    Icons.table_rows_outlined),
                _quickChip(palette, 'What could this be?',
                    Icons.account_tree_outlined),
                _quickChip(palette, 'Explain X-ray results',
                    Icons.medical_services_outlined),
                _quickChip(palette, 'Assess lung sounds', Icons.graphic_eq),
                _quickChip(palette, 'Check vital signs',
                    Icons.monitor_heart_outlined),
                _quickChip(
                    palette, 'Recommend next steps', Icons.lightbulb_outline),
                _quickChip(palette, 'Draft referral note',
  ...
  style: XSTypography.eyebrow(isUser
  ? XSColors.moduleAssistant
      ...
      child: Column(
        ...
        children: [
          ...
          Icon(Icons.psychology_outlined,
              size: 44 * s, color: XSColors.moduleAssistant),
          SizedBox(height: XSSpacing.sm * s),
          Text(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(item.icon,
                            size: 20 * s, color: XSColors.moduleAssistant),
                        SizedBox(width: XSSpacing.sm * s),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Icon(Icons.arrow_forward_ios,
                            size: 12 * s, color: palette.textSecondary),
                      ],
                    ),
                  ),
                ),
